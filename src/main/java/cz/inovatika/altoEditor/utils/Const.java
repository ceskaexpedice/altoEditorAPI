...
public class Const {
    ...
    public static final String PATH_DIGITAL_OBJECT_SIBLINGS = getPath(PATH_DIGITAL_OBJECT, "siblings");
    ...
    public static List<String> ADMINS_PATH = Arrays.asList(PATH_ROOT, PATH_APP, PATH_INFO, PATH_DB, PATH_DB_VERSIONS, PATH_DB_ACTUAL_VERSION,
            ...
            PATH_DIGITAL_OBJECT, PATH_DIGITAL_OBJECT_INFORMATION, PATH_DIGITAL_OBJECT_SIBLINGS, PATH_DIGITAL_OBJECT_IMAGE, PATH_DIGITAL_OBJECT_ALTO,
